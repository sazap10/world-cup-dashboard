      ...
      <table className="standings__table">
        <thead>
          <tr>
            ...
            <th className="col-opt" scope="col" title="Won">
              W
            </th>
            <th className="col-opt" scope="col" title="Drawn">
              D
            </th>
            <th className="col-opt" scope="col" title="Lost">
              L
            </th>
            <th className="col-opt" scope="col" title="Goals for">
              GF
            </th>
            <th className="col-opt" scope="col" title="Goals against">
              GA
            </th>
