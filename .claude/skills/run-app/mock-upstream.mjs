...
const payload = {
  matches: [
    {
      id: 1, utcDate: '2026-06-11T16:00:00Z', status: 'FINISHED', stage: 'GROUP_STAGE',
      group: 'Group A', matchday: 1, minute: null, venue: 'Estadio Azteca',
    ...
    {
      id: 2, utcDate: '2026-07-11T19:00:00Z', status: 'SCHEDULED', stage: 'FINAL',
      group: null, matchday: null, minute: null, venue: 'MetLife Stadium',
